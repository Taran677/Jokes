...
let indexofJokes = Math.random()
indexofJokes *= jokesArrayObject.length - 1
indexofJokes = Math.round(indexofJokes)
console.log(indexofJokes)
let processedJoke = jokesArrayObject[indexofJokes]
let jokeQn = processedJoke.question;
console.log(jokeQn)
let material1 = document.getElementsByTagName("h3")[0]
material1.innerHTML = jokeQn;
var delayInMilliseconds = 2000;
setTimeout(function () {
    let material2 = document.getElementsByTagName("h3")[1]
    let jokeAns = processedJoke.answer;
    material2.innerHTML = `"` + jokeAns + `"`;
    console.log(`"` + jokeAns + `"`)
}, delayInMilliseconds);
